...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(158);
	...
	var TodoActions = _reflux2.default.createActions(['getAll', 'addItem', 'deleteItem', 'updateItem']); /**
	...
	var TodoStore = _reflux2.default.createStore({
	  ...
	  onDeleteItem: function onDeleteItem(model, index) {
	    _jquery2.default.post('/delete', model, function (data) {
	      this.items.splice(index, 1);
	      this.trigger(this.items);
	    }.bind(this));
	  },
	  onUpdateItem: function onUpdateItem(model, index) {
	    _jquery2.default.post('/update', model, function (data) {
	...
	var TodoComponent = _react2.default.createClass({
	  ...
	  mixins: [_reflux2.default.connect(TodoStore, 'list')],
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      this.state.list.map(function (item) {
	        return _react2.default.createElement(TodoItem, { data: item });
	      })
	    );
	  }
	});
	...
	var TodoItem = _react2.default.createClass({
	  ...
	  handleDelete: function handleDelete(model, index) {
	    TodoActions.deleteItem(model, index);
	  },
	  handleUpdate: function handleUpdate(model) {
	...
	_react2.default.render(_react2.default.createElement(TodoComponent, null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.connect = __webpack_require__(172);

	Reflux.connectFilter = __webpack_require__(174);

	Reflux.ListenerMixin = __webpack_require__(173);

	Reflux.listenTo = __webpack_require__(175);

	Reflux.listenToMany = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.PublisherMethods = __webpack_require__(170);

	Reflux.StoreMethods = __webpack_require__(169);

	Reflux.createAction = __webpack_require__(171);

	Reflux.createStore = __webpack_require__(165);

	var maker = __webpack_require__(164).staticJoinCreator;
	...
	Reflux.__keep = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(162),
	    maker = __webpack_require__(164).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(165),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(162),
	    Keep = __webpack_require__(166),
	    mixer = __webpack_require__(167),
	    bindMethods = __webpack_require__(168);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(169),
	        PublisherMethods = __webpack_require__(170),
